//[voxatrace](../../../../index.md)/[com.musicmuni.voxatrace.calibra.model](../../index.md)/[VADBackend](../index.md)/[SINGING_REALTIME](index.md)

# SINGING_REALTIME

[common]\
[SINGING_REALTIME](index.md)

Real-time singing VAD using pitch detection.

Low latency (32ms windows), uses SwiftF0 pitch model. Good for real-time singing detection. Requires ai + ai-models dependencies.
