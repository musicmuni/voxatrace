//[voxatrace](../../../../index.md)/[com.musicmuni.voxatrace.calibra.model](../../index.md)/[VADBackend](../index.md)/[SINGING](index.md)
...
Singing-optimized VAD using Essentia YAMNet.

High accuracy for distinguishing singing from instruments. Larger model size (~15MB), higher latency (960ms windows). Requires ai + ai-models dependencies.
